    ...
    <div class="login-wrapper">
        ...
        <div class="login-right-panel">
            ...
            <div class="login-form-container">
                ...
                <form class="login-form-fields" onsubmit="event.preventDefault(); alert('Login simulated successfully!');">
                    ...
                    <div class="input-group">
                        ...
                        <div class="password-input-wrapper">
                            <input type="password" id="password" class="form-input password-field" placeholder="Enter your password" required>
